...
class Module(ModuleABC):
    ...
    def get_setup_messages(self):
        return [
            ["Time in seconds to record (Leave empty for 5): ","Time"],
            ["Remote output directory (Leave empty for /tmp): ","Outputdir"],
            ["Remote output name (Leave empty for <RANDOM>): ","OutputName"]
        ]
